...
<footer class={$$restProps.class || ''}>
  <p>
    <a href="https://github.com/Callie-Sylph/nuzlocke.app/issues/new?assignees=&labels=&projects=&template=bug_report.md&title="
  ...
  <span class='inline-flex items-center mb-2'>Maintained with <Icon inline={true} icon={Heart} class='mx-1 fill-current text-red-500' /> by<strong class=ml-1>Bassel</strong></span>
	<br/>
  <span class='inline-flex items-center mb-2'>Forked with <Icon inline={true} icon={Heart} class='mx-1 fill-current text-red-500' /> by<strong class=ml-1>CallieSylph</strong></span>
  <br />
